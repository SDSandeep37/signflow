...
const Login = () => {
  ...
  return (
    <div className="mt-6 min-h-screen flex items-center justify-center bg-linear-to-br from-black via-[#0a0f1f] to-[#000000] relative">
      {/* Background particles */}
      <div className="absolute inset-0 bg-[url('/background.png')] opacity-50"></div>
      ...
      <div className="relative z-10 w-full max-w-md bg-black/70 backdrop-blur-lg border border-blue-500/40 rounded-xl shadow-xl p-8">
        ...
        >
          <img src="/logo.png" alt="SignFlow Logo" />
        </div>

        {/* Title */}
        <h2 className="text-2xl font-bold text-white text-center mb-6">
          Welcome to <span className="text-blue-400">SignFlow</span>
        </h2>
